...
$string['date'] = 'Date';
$string['date_help'] = 'Event date.';
$string['place'] = 'Place';
$string['place_help'] = 'Event place.';
$string['placemapurl'] = 'Place url';
$string['placemapurl_help'] = 'Insert the place URL. It can be a Google Maps URL.';
