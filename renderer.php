...
/**
 * Renderer for outputting the moodlemoot course format.
 *
...
/**
 * Renderer class for moodlemoot format.
 */
class format_moodlemoot_renderer extends format_section_renderer_base {
    /**
