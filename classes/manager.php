...
class manager {
  ...
  protected function context_header_settings_menu()
  {
    ...
    if (($context->contextlevel == CONTEXT_COURSE) &&
      !empty($currentnode) && ($currentnode->type == navigation_node::TYPE_COURSE || $currentnode->type == navigation_node::TYPE_SECTION)
    ) {
      $showcoursemenu = true;
    }
    ...
    if (
      ...
      !empty($currentnode) && ($currentnode->key === 'myprofile')
    ) {
      $showusermenu = true;
    }
