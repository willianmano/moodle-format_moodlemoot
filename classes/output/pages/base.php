...
//require_once($CFG->dirroot . '/course/format/moodlemoot/renderer.php');
 ...
 */
abstract class base extends \format_moodlemoot_renderer {
    protected $course;
     ...
     * @param $course
     */
    public function __construct(moodle_page $page, $target, $course, $formatrenderer = null) {
        $this->course = $course;
     ...
     * @throws \coding_exception
     */
    public function extract_settingsmenu_icons($items) {
        global $USER;
